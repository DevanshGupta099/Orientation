...
export default function OrientationsPage({ initialFilters, onBackToHome }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      <section style={{ padding: '24px 0 10px', background: 'rgba(12, 35, 64, 0.01)' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="academic-panel" style={{ padding: '20px 24px', background: '#ffffff', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <strong style={{ fontSize: '1.05rem', color: 'var(--cu-navy-dark)', fontWeight: 800 }}>Academic Calendar Scheduler</strong>
              </div>
        ...
        <div className="container" style={{ padding: '12px 24px 50px', width: '100%' }}>
          ...
          {filteredSessions.length === 0 ? (
            ...
            // Full Grid displaying detailed card information directly
              ...
              {filteredSessions.map(session => (
                ...
                >
                  ...
                  <div style={{ marginTop: 'auto', paddingTop: '10px' }}>
                    <strong style={{ fontSize: '0.74rem', color: 'var(--cu-navy)', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.03em' }}>Key Takeaways:</strong>
                    <ul style={{ listStyleType: 'square', paddingLeft: '18px', display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '0.78rem', color: 'var(--text-main)' }}>
                  ...
                  {session.poster && (
                    <button
                      ...
                      className="nav-hover"
                    >
                      <ImageIcon size={14} /> View Session Poster
                    </button>
                  )}
                </motion.div>
              ))}
